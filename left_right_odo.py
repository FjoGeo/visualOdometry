...
class VisualOdometry():
    def __init__(self, data_dir):
        ...
        self.images2 = self._load_images(os.path.join(data_dir,"image_r"))
    ...
    def get_matches(self, i):
        ...
        kp1, des1 = self.orb.detectAndCompute(self.images2[i], None)
        ...
        img3 = cv2.drawMatches(self.images[i], kp1, self.images2[i],kp2, good ,None,**draw_params)
